...
public interface EstoqueApi {
    ...
    void gerarLoteCompras() throws JobExecutionAlreadyRunningException, JobRestartException, JobInstanceAlreadyCompleteException, JobParametersInvalidException;
